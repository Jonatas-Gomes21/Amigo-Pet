...
function Home() {
  ...
  return (
    <>
      <Helmet>
        <meta name="google-site-verification" content="Uah8hUu47lgWO1EZIzT3rC3o7uBz_cRWNVvoetOZK8c" />
        <title>
          Amigo Pet | Pet Shop e Clínica Veterinária em Lauro de Freitas
        </title>
        <meta
          name="description"
          content="Banho e tosa orgânica, clínica veterinária integrativa e hotel para pets em Lauro de Freitas, Bahia. Agende online!"
        />
        <meta
          name="keywords"
          content="pet shop Lauro de Freitas, veterinário Bahia, banho e tosa, hotel para pets"
        />
        <link rel="canonical" href="https://amigo-petshop.vercel.app/" />
      </Helmet>
          ...
          >
            <div className="flex flex-col items-center md:items-start gap-6 w-full">
              ...
              <p className="text-stone-600 text-center md:text-start text-base md:text-lg font-normal font-['Hanken_Grotesk'] leading-relaxed max-w-md md:max-w-xl">
                ...
                excelência para oferecer o melhor em saúde e bem-estar animal.
                Uma experiência premium focada na vitalidade do seu pet.
              </p>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-8 mt-4">
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-stone-600 font-['Hanken_Grotesk'] leading-relaxed">
                    Utilizamos exclusivamente produtos de origem botânica,
                    livres de parabenos e químicos agressivos, respeitando o
                    equilíbrio natural da pele do seu pet.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-stone-600 font-['Hanken_Grotesk'] leading-relaxed">
                    Desenhamos nosso espaço minimizando ruídos e estresse
                    visual. Música suave, aromaterapia leve e muito carinho
                    esperam por vocês.
                  </p>
                </div>
              </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 gap-12 w-full mt-12">
              ...
              >
                ...
                <div className="w-full md:w-2/5 flex flex-col justify-center gap-6 p-8 md:p-12 text-left">
                  ...
                  <p className="text-stone-700 text-sm font-normal font-['Hanken_Grotesk'] leading-relaxed max-w-xl">
                    ...
                    xampus à base de plantas, ozonioterapia e técnicas de
                    massagem relaxante para uma pelagem brilhante e pele
                    saudável, sem estresse.
                  </p>
              ...
              >
                ...
                <div className="w-full md:w-2/5 flex flex-col justify-center gap-6 p-8 md:p-12 text-left">
                  ...
                  <p className="text-stone-700 text-sm font-normal font-['Hanken_Grotesk'] leading-relaxed max-w-xl">
                    Um espaço de socialização desenhado para o bem-estar mental
                    e físico do seu pet. Áreas separadas por porte e
                    temperamento, com recreação monitorada por especialistas em
              ...
              >
                ...
                <div className="relative flex flex-col items-center text-center gap-6 p-8 pt-12 shadow-xl rounded-2xl bg-stone-50 border border-stone-100 overflow-hidden w-full h-full">
                  ...
                  <p className="text-stone-700 font-['Hanken_Grotesk'] text-lg italic leading-relaxed z-10">
                    "A pelagem do meu Golden Retriever mudou completamente
                    depois que começamos o spa orgânico. O ambiente é tão calmo
                    que ele entra abanando o rabo, algo que nunca aconteceu em
                    outros lugares."
                  </p>
              ...
              >
                ...
                <div className="relative flex flex-col items-center text-center gap-6 p-8 pt-12 shadow-xl rounded-2xl bg-stone-50 border border-stone-100 w-full h-full">
                  <p className="text-stone-700 font-['Hanken_Grotesk'] text-lg italic leading-relaxed z-10">
                    ...
                    paciência e carinho, recomendo de olhos fechados!"
                  </p>
